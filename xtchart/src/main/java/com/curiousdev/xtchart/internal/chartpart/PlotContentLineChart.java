...
public class PlotContentLineChart extends PlotContent {
  ...
  public void paint(Graphics2D g) {
    ...
    for (Series series : getChartPainter().getAxisPair().getSeriesMap().values()) {
      ...
      TDoubleArrayList yData = series.getYData();
      ...
      TDoubleIterator xItr = xData.iterator();
      TDoubleIterator yItr = yData.iterator();
      TDoubleIterator ebItr = null;
      TDoubleArrayList errorBars = series.getErrorBars();
      if (errorBars != null) {
      ...
      while (xItr.hasNext()) {
        ...
        // paint line
        if (series.getStroke() != null && getChartPainter().getStyleManager().getChartType() != StyleManager.ChartType.Scatter) {
