...
public class NumberFormatter {
  ...
  public String formatNumber(BigDecimal value, double min, double max, Axis.Direction axisDirection) {
    ...
    if (axisDirection == Axis.Direction.X && styleManager.getXAxisDecimalPattern() != null) {

      decimalPattern = styleManager.getXAxisDecimalPattern();
    }
    else if (axisDirection == Axis.Direction.Y && styleManager.getYAxisDecimalPattern() != null) {
