...
public class CSVExporter {
  ...
  public static void writeCSVColumns(Series series, String path2Dir) {
    ...
    try {
      ...
      TDoubleArrayList  errorBarData = series.getErrorBars();
      TDoubleIterator itrx = xData.iterator();
      TDoubleIterator itry = yData.iterator();

      TDoubleIterator itrErrorBar = null;
   ...
   * @return
   */
  private static String join(TDoubleArrayList collection, String separator) {
