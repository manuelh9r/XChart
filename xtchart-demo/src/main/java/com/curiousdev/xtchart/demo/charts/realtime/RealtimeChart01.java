  ...
  public static void main(String[] args) {
    ...
    TimerTask chartUpdaterTask = new TimerTask() {
      ...
      public void run() {
        ...
        TDoubleArrayList tDoubleArrayList = new TDoubleArrayList(realtimeChart01.getyData().size());
        tDoubleArrayList.addAll(realtimeChart01.getyData());

        chartPanel.updateSeries(SERIES_NAME, tDoubleArrayList);
